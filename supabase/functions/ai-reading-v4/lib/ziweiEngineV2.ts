...
// ─── 14주성 밝기 테이블 (12궁: 자축인묘진사오미신유술해) ───
const BRIGHTNESS_TABLE: Record<string, StarBrightness[]> = {
...
const AUX_BRIGHTNESS_TABLE: Record<string, StarBrightness[]> = {
  ...
  문창: ["득지","평화","묘","왕","득지","평화","득지","평화","묘","왕","득지","평화"],
  문곡: ["득지","평화","묘","왕","득지","평화","득지","평화","묘","왕","득지","평화"],
  록존: ["묘","묘","왕","왕","묘","묘","왕","왕","묘","묘","왕","왕"],
  천괴: ["묘","왕","득지","득지","묘","평화","묘","왕","득지","득지","묘","평화"],
  천월: ["묘","왕","득지","득지","묘","평화","묘","왕","득지","득지","묘","평화"],
  경양: ["함지","평화","묘","득지","함지","평화","함지","평화","묘","득지","함지","평화"],
  타라: ["평화","함지","득지","묘","평화","함지","평화","함지","득지","묘","평화","함지"],
  화성: ["함지","평화","득지","함지","평화","묘","함지","평화","득지","함지","평화","묘"],
  영성: ["함지","평화","득지","함지","평화","묘","함지","평화","득지","함지","평화","묘"],
  지공: ["평화","평화","평화","평화","평화","평화","평화","평화","평화","평화","평화","평화"],
  지겁: ["평화","평화","평화","평화","평화","평화","평화","평화","평화","평화","평화","평화"],
};

function getStarBrightness(star: string, palaceIdx: number): StarBrightness {
  const idx = ((palaceIdx % 12) + 12) % 12;
  if (BRIGHTNESS_TABLE[star]) return BRIGHTNESS_TABLE[star][idx];
  if (AUX_BRIGHTNESS_TABLE[star]) return AUX_BRIGHTNESS_TABLE[star][idx];
  return "평화"; // 신살 등 밝기 미적용 항목
}
