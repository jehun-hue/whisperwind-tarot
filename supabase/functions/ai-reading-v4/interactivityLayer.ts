...
[시기 명시 규칙 / Timing Specificity Rules]
- priority_events의 peak_period에 구체적 날짜나 월이 포함되어 있으면, 반드시 본문에 해당 시기를 명시하세요.
- 예: peak_period가 "4월~9월 (2026-04-11 전후 집중)"이면, 본문에 "4월부터 9월 사이, 특히 4월 중순 전후"라고 반드시 쓰세요.
- "단기적으로", "장기적으로"만 쓰고 구체적 월을 생략하면 안 됩니다.
- decision_trigger가 있으면 "이 시기 전후로 중요한 결정이 필요합니다"라고 반드시 포함하세요.
- 날짜는 "2026-04-11"이 아니라 "4월 중순 전후"처럼 자연스럽게 표현하세요.
