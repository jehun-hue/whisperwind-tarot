...
export function buildStyleApplyPrompt(
  ...
  const STYLE_ROLE: Record<string, string> = {
    ...
    e7l3: "감성 중심 통합 리딩. 감정 70%, 논리 30%. 따뜻하고 공감하는 톤으로 위로와 격려 중심으로 서술하세요. 핵심: '당신의 마음을 이해하며, 이렇게 하면 좋겠다'",
    e5l5: "완벽한 균형 분석가. 감정과 논리를 정확히 50:50으로 배분하세요. 모든 엔진 데이터를 균형 있게 통합하되, 다른 스타일과 중복 금지. 핵심: '객관적 데이터와 주관적 감정을 모두 고려한 최적 판단'",
