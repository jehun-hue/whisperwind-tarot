...
반드시 아래 JSON만 출력하세요. 각 필드는 최소 4-6문장 이상 충실히 작성하세요.
{
  ...
  "ziweiAnalysis": "자미두수 심층 분석 (명궁 주성의 밝기별 해석, 사화(화록/화권/화과/화기)가 각 궁에 미치는 영향, 질문 관련 궁위 집중 분석, 생년사화와 대한사화의 상호작용. 최소 6문장)",
  "ziweiLifeStructure": "자미두수 인생 구조 및 시기 분석 (12궁 전체 흐름, 현재 대한(大限)의 궁위와 별의 상태, 소한(小限)의 올해 에너지 방향, 사화가 가리키는 핵심 기회와 위험. 최소 5문장)",
