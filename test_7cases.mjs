...
const cases=[
  ...
  {name:"5.한소희",y:1993,m:9,d:25,h:20,mi:0,g:'F',p:["癸酉","辛酉","己酉","甲戌"],dm:"己",yo:"금",he:"수",gi:"토",gu:"화",ha:"화",yi:6,ya:2,el:{목:1,화:0,토:2,금:4,수:1},tg:{비겁:1,식상:4,재성:1,관성:1,인성:0},ds:4,dd:"순행"},
  ...
  {name: "10.신약여",y: 1992, m: 6, d: 15, h: 11, mi: 0, g: "F", p: ["壬申", "丙午", "壬戌", "乙巳"], dm: "壬", yo: "화", he: "토", gi: "수", gu: "금", ha: "수", ds: 3, dd: "역행"},
