(async () => {
  try {
    let r = await fetch('https://gbmiciumkbsyamdbaddr.supabase.co/functions/v1/ai-reading-v4', {
      ...
      body: JSON.stringify({
        birthInfo: { date: '1987-06-15', time: '12:00', gender: 'male', name: 'STRUCT' },
        question: 'test',
    ...
    console.log('reading keys:', Object.keys(d.reading || {}));
    console.log('saju_analysis keys:', Object.keys(d.reading?.saju_analysis || {}));
    console.log('has _debug:', JSON.stringify(d.reading?._debug_sajuRaw_keys));
  } catch (err) {
