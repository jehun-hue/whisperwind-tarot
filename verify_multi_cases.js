(async () => {
    ...
    try {
      for(const c of cases){
        ...
        const sd = s?.strength_detail;
        console.log(`=== ${c.name} ===`);
        console.log('dayMaster:', s?.dayMaster, 'strength:', s?.strength);
        console.log('score:', sd?.score, '/', sd?.totalPossible, 'percent:', sd?.percent);
        console.log('breakdown:', JSON.stringify(sd?.breakdown, null, 2));
